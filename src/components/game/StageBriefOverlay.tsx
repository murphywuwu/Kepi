...
import { StageBriefCard } from "./StageBriefCard";
...
export function StageBriefOverlay() {
  ...
  return (
    ...
    >
      ...
      <div className="kepi-stage-brief-overlay__card relative w-full max-w-xl">
        ...
        <div className="mt-2 flex justify-end border-t border-dashed border-amber-200/22 px-5 pb-5 pt-4 sm:px-7">
          <button
            ...
            onClick={() => dismissStageBrief(state.currentNodeId)}
          >
            <span>进入备战</span>
